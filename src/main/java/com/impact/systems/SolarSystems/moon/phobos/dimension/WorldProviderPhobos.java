...
import com.impact.systems.SolarSystems.moon.phobos.dimension.sky.SkyProviderPhobos;
...
public class WorldProviderPhobos extends WorldProviderAdvancedSpace implements IExitHeight, ISolarLevel, ITeleportType, IAdvancedSpace {

    public WorldProviderPhobos() {
    }
    ...
    public IRenderHandler getSkyRenderer() {
        if (super.getSkyRenderer() == null) this.setSkyRenderer(new SkyProviderPhobos());
