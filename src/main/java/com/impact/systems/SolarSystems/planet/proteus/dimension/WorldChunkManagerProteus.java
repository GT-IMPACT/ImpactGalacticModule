...
import com.impact.systems.SolarSystems.planet.proteus.world.layer.GenLayerProteus;
...
public class WorldChunkManagerProteus extends WorldChunkManagerSpace {
    ...
    protected WorldChunkManagerProteus() {
        this.myBiomeCache = new BiomeCache(this);
        this.myBiomesToSpawnIn = new ArrayList();
        this.myBiomesToSpawnIn.add(this.getBiome());
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpace.setBiomeName("Proteus"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowPlains.setBiomeName("ProteusLowPlains"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowHills.setBiomeName("ProteusLowHills"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceMidPlains.setBiomeName("ProteusMidPlains"));
    }

    public WorldChunkManagerProteus(long seed) {
        this();
        GenLayer[] agenlayer = GenLayerProteus.makeTheWorld(seed);
        this.unzoomedBiomes = agenlayer[0];
        this.zoomedBiomes = agenlayer[1];
    }

    public WorldChunkManagerProteus(World world) {
        this(world.getSeed());
    }

    public BiomeGenBase getBiome() {
        return GSBiomeGenBase.GSSpace.setBiomeName("Proteus");
    }
