...
public class WorldProviderHaumea extends WorldProviderAdvancedSpace implements IExitHeight, ISolarLevel, ITeleportType, IAdvancedSpace {

    public WorldProviderHaumea() {
    }
    ...
    public CelestialBody getCelestialBody() {
        return SolarSystemBodies.planetHaumea;
    }

    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return ChunkProviderHaumea.class;
    }
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerHaumea.class;
    }
    ...
    public IRenderHandler getSkyRenderer() {
        if (super.getSkyRenderer() == null) this.setSkyRenderer(new SkyProviderHaumea());
