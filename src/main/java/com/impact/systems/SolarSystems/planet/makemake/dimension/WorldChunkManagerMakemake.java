...
public class WorldChunkManagerMakemake extends WorldChunkManagerSpace {
    ...
    protected WorldChunkManagerMakemake() {
        this.myBiomeCache = new BiomeCache(this);
        this.myBiomesToSpawnIn = new ArrayList();
        this.myBiomesToSpawnIn.add(this.getBiome());
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpace.setBiomeName("Makemake"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowPlains.setBiomeName("MakemakeLowPlains"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowHills.setBiomeName("MakemakeLowHills"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceMidPlains.setBiomeName("MakemakeMidPlains"));
    }

    public WorldChunkManagerMakemake(long seed) {
        this();
        GenLayer[] agenlayer = GenLayerMakemake.makeTheWorld(seed);
        this.unzoomedBiomes = agenlayer[0];
        this.zoomedBiomes = agenlayer[1];
    }

    public WorldChunkManagerMakemake(World world) {
        this(world.getSeed());
    }

    public BiomeGenBase getBiome() {
        return GSBiomeGenBase.GSSpace.setBiomeName("Makemake");
    }
