...
import com.impact.systems.SolarSystems.planet.proteus.dimension.sky.SkyProviderProteus;
...
public class WorldProviderProteus extends WorldProviderAdvancedSpace implements IExitHeight, ISolarLevel, ITeleportType, IAdvancedSpace {

    public WorldProviderProteus() {
    }
    ...
    public CelestialBody getCelestialBody() {
        return SolarSystemBodies.proteusNeptune;
    }

    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return ChunkProviderProteus.class;
    }
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerProteus.class;
    }
    ...
    public IRenderHandler getSkyRenderer() {
        if (super.getSkyRenderer() == null) this.setSkyRenderer(new SkyProviderProteus());
