...
import com.impact.systems.SolarSystems.moon.phobos.world.gen.layer.GenLayerPhobos;
...
public class WorldChunkManagerPhobos extends WorldChunkManagerSpace {
    ...
    protected WorldChunkManagerPhobos() {
        this.myBiomeCache = new BiomeCache(this);
        this.myBiomesToSpawnIn = new ArrayList();
        this.myBiomesToSpawnIn.add(this.getBiome());
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpace.setBiomeName("Phobos"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowPlains.setBiomeName("PhobosLowPlains"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowHills.setBiomeName("PhobosLowHills"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceMidPlains.setBiomeName("PhobosMidPlains"));
    }

    public WorldChunkManagerPhobos(long seed) {
        this();
        GenLayer[] agenlayer = GenLayerPhobos.makeTheWorld(seed);
        this.unzoomedBiomes = agenlayer[0];
        this.zoomedBiomes = agenlayer[1];
    }

    public WorldChunkManagerPhobos(World world) {
        this(world.getSeed());
    }

    public BiomeGenBase getBiome() {
        return GSBiomeGenBase.GSSpace.setBiomeName("Phobos");
    }
