...
import com.impact.systems.SolarSystems.planet.oberon.dimension.sky.SkyProviderOberon;
...
public class WorldProviderOberon extends WorldProviderAdvancedSpace implements IExitHeight, ISolarLevel, ITeleportType, IAdvancedSpace {

    public WorldProviderOberon() {
    }
    ...
    public CelestialBody getCelestialBody() {
        return SolarSystemBodies.oberonUranus;
    }
    ...
    public IRenderHandler getSkyRenderer() {
        if (super.getSkyRenderer() == null) this.setSkyRenderer(new SkyProviderOberon());
