...
import com.impact.systems.SolarSystems.moon.deimos.dimension.sky.SkyProviderDeimos;
...
public class WorldProviderDeimos extends WorldProviderAdvancedSpace implements IExitHeight, ISolarLevel, ITeleportType, IAdvancedSpace {
    ...
    public IRenderHandler getSkyRenderer() {
        if (super.getSkyRenderer() == null) this.setSkyRenderer(new SkyProviderDeimos());
