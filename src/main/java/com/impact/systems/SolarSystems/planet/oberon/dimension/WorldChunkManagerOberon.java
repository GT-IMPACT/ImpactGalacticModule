...
import com.impact.systems.SolarSystems.planet.oberon.world.layer.GenLayerOberon;
...
public class WorldChunkManagerOberon extends WorldChunkManagerSpace {
    ...
    protected WorldChunkManagerOberon() {
        ...
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpace.setBiomeName("Oberon"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowPlains.setBiomeName("OberonLowPlains"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowHills.setBiomeName("OberonLowHills"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceMidPlains.setBiomeName("OberonMidPlains"));
    }

    public WorldChunkManagerOberon(long seed) {
        this();
        GenLayer[] agenlayer = GenLayerOberon.makeTheWorld(seed);
    ...
    public BiomeGenBase getBiome() {
        return GSBiomeGenBase.GSSpace.setBiomeName("Oberon");
    }
