...
public class MapGenCavesMakemake extends MapGenBaseMeta {
    public static final int BREAK_THROUGH_CHANCE = 25;

    public MapGenCavesMakemake() {
    }
                            ...
                            for (int localZ = l2; localZ < i3; ++localZ) {
                                ...
                                if (xfactorSq + zfactorSq < 1.0D) {
                                    ...
                                    if (yfactor > -0.7D && xfactorSq + yfactorSq + zfactorSq < 1.0D) {
                                        if (blockIdArray[coords] == IGM_Blocks.MakeMakeBlocks && metaArray[coords] == 0 && random.nextInt(25) == 0) {
                                            blockIdArray[coords] = Blocks.air;
                                        } else if (blockIdArray[coords] == IGM_Blocks.MakeMakeBlocks && metaArray[coords] == 1) {
                                            blockIdArray[coords] = Blocks.air;
                                        }
                                    }
                                }
