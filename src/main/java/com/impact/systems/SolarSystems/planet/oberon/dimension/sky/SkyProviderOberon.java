...
import static com.impact.ImpactGalacticModule.TEXTURE_PATH;
...
public class SkyProviderOberon extends IRenderHandler {
    ...
    public void render(float partialTicks, WorldClient world, Minecraft mc) {
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        (FMLClientHandler.instance().getClient()).renderEngine.bindTexture(uranusTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f11, -100.0D, f11, 0.0D, 1.0D);
        tessellator1.addVertexWithUV(f11, -100.0D, f11, 1.0D, 1.0D);
        tessellator1.addVertexWithUV(f11, -100.0D, -f11, 1.0D, 0.0D);
        ...
        GL11.glRotatef(-75.0F, 1.0F, 0.0F, 0.0F);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        (FMLClientHandler.instance().getClient()).renderEngine.bindTexture(uranusRingsTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f11, -100.0D, f11, 0.0D, 1.0D);
        tessellator1.addVertexWithUV(f11, -100.0D, f11, 1.0D, 1.0D);
        tessellator1.addVertexWithUV(f11, -100.0D, -f11, 1.0D, 0.0D);
        ...
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        (FMLClientHandler.instance().getClient()).renderEngine.bindTexture(oberonTexture);
        tessellator1.startDrawingQuads();
        tessellator1.addVertexWithUV(-f11, -100.0D, f11, 0.0D, 1.0D);
        tessellator1.addVertexWithUV(f11, -100.0D, f11, 1.0D, 1.0D);
        tessellator1.addVertexWithUV(f11, -100.0D, -f11, 1.0D, 0.0D);
