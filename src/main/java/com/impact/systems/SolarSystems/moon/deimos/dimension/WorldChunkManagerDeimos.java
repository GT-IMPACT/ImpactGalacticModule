...
import com.impact.systems.SolarSystems.moon.deimos.world.gen.layer.GenLayerDeimos;
...
public class WorldChunkManagerDeimos extends WorldChunkManagerSpace {
    ...
    protected WorldChunkManagerDeimos() {
        this.myBiomeCache = new BiomeCache(this);
        this.myBiomesToSpawnIn = new ArrayList();
        this.myBiomesToSpawnIn.add(this.getBiome());
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpace.setBiomeName("Deimos"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowPlains.setBiomeName("DeimosLowPlains"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceLowHills.setBiomeName("DeimosLowHills"));
        this.myBiomesToSpawnIn.add(GSBiomeGenBase.GSSpaceMidPlains.setBiomeName("DeimosMidPlains"));
    }

    public WorldChunkManagerDeimos(long seed) {
        this();
        GenLayer[] agenlayer = GenLayerDeimos.makeTheWorld(seed);
        this.unzoomedBiomes = agenlayer[0];
        this.zoomedBiomes = agenlayer[1];
    }

    public WorldChunkManagerDeimos(World world) {
        this(world.getSeed());
    }

    public BiomeGenBase getBiome() {
        return GSBiomeGenBase.GSSpace.setBiomeName("Deimos");
    }
